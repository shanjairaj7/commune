...
const SOLANA_WALLET = process.env.COMMUNE_SOLANA_WALLET_ADDRESS || '';
...
function matchRoute(method: string, originalUrl: string): string | null {
  // Normalize: strip query string, ensure /v1/ prefix
...
async function verifyPayment(
  ...
  try {
    ...
    // Extract payer wallet address from the payment signature
...
/** Extract wallet address from base64-encoded payment signature. */
